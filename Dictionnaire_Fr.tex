...
\entry{Parallelisme dynamique}{n.m}{Le porcesseur decide à l'éxécution quelles sont les instructions à éxécuter en parallèle}

\entry{Parallelisme statique}{n.m}{Le compiler decide quelles sont les instructions à éxécuter en parallele}
